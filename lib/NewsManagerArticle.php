...
class NewsManagerArticle
{
    ...
    private $pid;
    private $status;
    private $podcastmanager_category_id;
    private $title;
    private $richtext;
    private $images;
    ...
    {
        return $this->podcastmanager_category_id;
    }
    ...
    public function setNewsmanager_category_id($podcastmanager_category_id)
    {
        $this->podcastmanager_category_id = $podcastmanager_category_id;
    }
    ...
    public function getHrefLangTag($article_id)
    {
        ...
        foreach ($result as $value) {
            ...
            if ($lang) {
                $output .= '<link rel="alternate" hreflang="' . $lang->getCode() . '" href="' . substr(rex::getServer(), 0, -1) . rex_getUrl('', $lang->getId(), ['podcastmanager' => $value['id']]) . '" />' . PHP_EOL;
            }
        }
        return $output;
    }

    public function makeImage($media_name, $mediamanager_type = 'podcastmanager')
    {
