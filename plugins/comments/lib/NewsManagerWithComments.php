...
class NewsManagerWithComments extends NewsManager
{
    ...
    public function __construct() {
        parent::__construct();
        $this->commenttpl = new Template(rex_path::pluginData('podcastmanager', 'comments') . 'views/');
    }
    ...
    public static function saveComment() {
        ...
        $podcastmanager = new NewsManagerWithComments();
        ...
        $query = ''
                . 'INSERT INTO ' . rex::getTablePrefix() . 'podcastmanager_comments '
        ...
        return $headline.$podcastmanager->commenttpl->render($suggestions, $variable_array);
    }
    ...
    public function getCommentJavaScript($jquery_installed = false) {
        ...
        $output .= '<script type="text/javascript" src="' . rex::getServer() . 'assets/addons/podcastmanager/plugins/comments/js/podcastmanager-comment.min.js"></script>'.PHP_EOL;
