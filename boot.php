...
if (rex::isBackend() && is_object(rex::getUser())) {
    rex_perm::register('podcastmanager[]');
    rex_perm::register('podcastmanagersettings[]');
}
...
//rex_extension::register('REX_FORM_SAVED', array('PodcastManager', 'generateRssFeeds'), rex_extension::LATE);
//rex_extension::register('REX_FORM_DELETED', array('PodcastManager', 'generateRssFeeds'), rex_extension::LATE);
//rex_extension::register('REX_LIST_GET', array('PodcastManager', 'generateRssFeeds'), rex_extension::LATE);